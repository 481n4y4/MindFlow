      ...
      <main className="container mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-1">{todos.length}</p>
              </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="border-b border-gray-200 px-6 py-4">
            ...
            <p className="text-gray-600 mt-1">Kelola aktivitas dan catatan Anda</p>
          </div>
              ...
              <div className="text-center py-12">
                {searchTerm ? (
                  <>
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-900">Todo tidak ditemukan</h3>
                    <p className="mt-1 text-gray-500">Tidak ada todo yang cocok dengan pencarian "{searchTerm}"</p>
                  </>
                ) : (
                  <>
                    <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p className="mt-1 text-gray-500">Mulai dengan menambahkan todo pertama Anda!</p>
                  </>
                )}
              </div>
            ) : (
                ...
                {filteredTodos.map((todo) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        onClick={() => navigate(`/todo/${todo._id}/edit`)}
          ...
          {!isLoading && filteredTodos.length > 0 && (
            <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
              <div className="flex justify-between items-center text-sm text-gray-600">
                <span>
                  Menampilkan <span className="font-medium">{filteredTodos.length}</span> dari <span className="font-medium">{todos.length}</span> todo
                </span>
                <div className="flex items-center gap-4">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <p className="text-gray-600">© {new Date().getFullYear()} MindFlow. All rights reserved.</p>
            </div>
            <div className="flex gap-6">
              <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Bantuan</a>
              <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Kebijakan Privasi</a>
              <a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Syarat Layanan</a>
            </div>
          </div>
        </div>
      </footer>
